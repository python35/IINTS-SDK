...
- In the clean certified arm used for the main figure, `ExampleAlgorithm` reached `93.04%` Time in Range and had the lowest intervention burden of all included controllers.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Correction Bolus | 720 | 83.23 | 82.47 to 83.99 | 4.82 | 11.95 | 122.83 | 34.33 | 252.69 | Highest full-bundle mean TIR, but with high low-glucose exposure and the largest intervention load |
| ExampleAlgorithm | 720 | 82.40 | 81.67 to 83.14 | 2.56 | 15.04 | 144.56 | 30.70 | 109.43 | Candidate controller; second full-bundle TIR, lowest intervention burden and lower low-glucose exposure |
| Standard Pump | 720 | 82.22 | 81.52 to 82.93 | 3.22 | 14.56 | 137.73 | 30.88 | 204.75 | Strong comparator, close to the candidate on TIR but with more interventions |
| Clinical Baseline | 720 | 80.56 | 79.84 to 81.27 | 3.49 | 15.96 | 136.33 | 34.06 | 223.19 | Clinician-style heuristic comparator with higher intervention burden |
| PID Controller | 720 | 78.69 | 77.96 to 79.42 | 9.28 | 12.03 | 121.60 | 38.10 | 201.48 | Lowest TIR and highest low-glucose exposure in the full bundle |
...
- `Standard Pump` achieved slightly lower time above range than the candidate, but also lower TIR, higher low-glucose exposure, and more interventions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| clean_certified | 1200 | 90.30 | 89.88 to 90.72 | 6.45 | 3.25 | 177.19 | 743 | 0 |
| corrupted_uncertified | 1200 | 73.19 | 72.70 to 73.68 | 3.69 | 23.12 | 219.72 | 560 | 0 |
| supervisor_off_ablation | 1200 | 80.78 | 80.48 to 81.07 | 3.88 | 15.35 | 198.02 | 193 | 0 |

Key arm-level differences:
- clean certified vs corrupted uncertified TIR delta: `+17.11` points
- clean certified vs corrupted uncertified intervention delta: `-42.53`
- clean certified vs supervisor-off TIR delta: `+9.52` points
- clean certified vs supervisor-off time-above-range delta: `-12.10` points
- clean certified vs supervisor-off time-below-range delta: `+2.57` points
...
- versus `PID Controller`, `Clinical Baseline`, and `Standard Pump`, the candidate improved TIR while reducing low-glucose exposure and interventions
...
- **H1:** supported
  Clean certified conditions outperformed corrupted uncertified conditions by 17.11 TIR points and required fewer interventions.

- **H2:** mixed / partially supported
  Clean supervised conditions improved Time in Range and reduced hyperglycemia compared with supervisor-off, but they also increased low-glucose exposure in this benchmark. The safety layer should therefore be analyzed as a trade-off mechanism rather than described as an automatic risk reducer.
...
- The candidate controller reduced low-glucose exposure and interventions versus every baseline, including the higher-TIR `Correction Bolus` baseline.
