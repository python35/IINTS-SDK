    ...
    *,
    ...
    if board == "uno_q":
        guide_lines = [
            ...
            "",
            "```bash",
            f"iints edge status --workspace {workspace_name}",
            "```",
            "",
            ...
            "",
            "The Linux runtime scaffold and the STM32 bridge scaffold are both generated for you.",
            "Automatic serial forwarding from the Linux runtime to the STM32 side is not bundled yet.",
            "So the recommended first success target is:",
            "",
            ...
            "",
            f"- `iints patient status --workspace {workspace_name}`",
            f"- `iints patient kiosk --workspace {workspace_name}`",
            f"- `iints patient expo-reset --workspace {workspace_name}`",
            f"- `iints edge bundle --workspace {workspace_name} --output edge_bundle.zip`",
            "",
        ]
    else:
        guide_lines = [
