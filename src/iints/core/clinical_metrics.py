#!/usr/bin/env python3
"""
Core Clinical Metrics - IINTS-AF
Dependency-light clinical metrics shared by core, data, validation, and reports.
...
def demo_clinical_metrics():
    ...
    glucose = base_glucose + rng.normal(0, 15, n_points)

    # Add some excursions
    glucose[50:60] = rng.uniform(200, 280, 10)  # Morning high
    glucose[140:150] = rng.uniform(50, 65, 10)  # Afternoon low
